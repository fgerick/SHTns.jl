...
function SHsph_to_spat(arg1, Slm, Vt, Vp)
    ccall((:SHsph_to_spat, libshtns), Cvoid, (shtns_cfg, Ptr{cplx}, Ptr{Cdouble}, Ptr{Cdouble}), arg1, Slm, Vt, Vp)
end

function SHsph_to_spat_l(arg1, Slm, Vt, Vp, ltr)
    ccall((:SHsph_to_spat_l, libshtns), Cvoid, (shtns_cfg, Ptr{cplx}, Ptr{Cdouble}, Ptr{Cdouble}, Cint), arg1, Slm, Vt, Vp, ltr)
end

function SHsph_to_spat_ml(arg1, im, Sl, Vt, Vp, ltr)
    ccall((:SHsph_to_spat_ml, libshtns), Cvoid, (shtns_cfg, Cint, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}, Cint), arg1, im, Sl, Vt, Vp, ltr)
end
...
function SH_Zrotate(arg1, Qlm, alpha, Rlm)
    ccall((:SH_Zrotate, libshtns), Cvoid, (shtns_cfg, Ptr{cplx}, Cdouble, Ptr{cplx}), arg1, Qlm, alpha, Rlm)
end

function SH_Yrotate(arg1, Qlm, alpha, Rlm)
    ccall((:SH_Yrotate, libshtns), Cvoid, (shtns_cfg, Ptr{cplx}, Cdouble, Ptr{cplx}), arg1, Qlm, alpha, Rlm)
end

function SH_Yrotate90(arg1, Qlm, Rlm)
    ccall((:SH_Yrotate90, libshtns), Cvoid, (shtns_cfg, Ptr{cplx}, Ptr{cplx}), arg1, Qlm, Rlm)
end

function SH_Xrotate90(arg1, Qlm, Rlm)
    ccall((:SH_Xrotate90, libshtns), Cvoid, (shtns_cfg, Ptr{cplx}, Ptr{cplx}), arg1, Qlm, Rlm)
end
...
function SH_mul_mx(arg1, mx, Qlm, Rlm)
    ccall((:SH_mul_mx, libshtns), Cvoid, (shtns_cfg, Ptr{Cdouble}, Ptr{cplx}, Ptr{cplx}), arg1, mx, Qlm, Rlm)
end
...
function spat_to_SHsphtor(arg1, Vt, Vp, Slm, Tlm)
    ccall((:spat_to_SHsphtor, libshtns), Cvoid, (shtns_cfg, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{cplx}, Ptr{cplx}), arg1, Vt, Vp, Slm, Tlm)
end

function SHsphtor_to_spat(arg1, Slm, Tlm, Vt, Vp)
    ccall((:SHsphtor_to_spat, libshtns), Cvoid, (shtns_cfg, Ptr{cplx}, Ptr{cplx}, Ptr{Cdouble}, Ptr{Cdouble}), arg1, Slm, Tlm, Vt, Vp)
end

function SHtor_to_spat(arg1, Tlm, Vt, Vp)
    ccall((:SHtor_to_spat, libshtns), Cvoid, (shtns_cfg, Ptr{cplx}, Ptr{Cdouble}, Ptr{Cdouble}), arg1, Tlm, Vt, Vp)
end

function spat_cplx_to_SHsphtor(arg1, Vt, Vp, Slm, Tlm)
    ccall((:spat_cplx_to_SHsphtor, libshtns), Cvoid, (shtns_cfg, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}), arg1, Vt, Vp, Slm, Tlm)
end

function SHsphtor_to_spat_cplx(arg1, Slm, Tlm, Vt, Vp)
    ccall((:SHsphtor_to_spat_cplx, libshtns), Cvoid, (shtns_cfg, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}), arg1, Slm, Tlm, Vt, Vp)
end

function spat_to_SHqst(arg1, Vr, Vt, Vp, Qlm, Slm, Tlm)
    ccall((:spat_to_SHqst, libshtns), Cvoid, (shtns_cfg, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}), arg1, Vr, Vt, Vp, Qlm, Slm, Tlm)
end

function SHqst_to_spat(arg1, Qlm, Slm, Tlm, Vr, Vt, Vp)
    ccall((:SHqst_to_spat, libshtns), Cvoid, (shtns_cfg, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}), arg1, Qlm, Slm, Tlm, Vr, Vt, Vp)
end

function spat_cplx_to_SHqst(arg1, Vr, Vt, Vp, Qlm, Slm, Tlm)
    ccall((:spat_cplx_to_SHqst, libshtns), Cvoid, (shtns_cfg, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}), arg1, Vr, Vt, Vp, Qlm, Slm, Tlm)
end

function SHqst_to_spat_cplx(arg1, Qlm, Slm, Tlm, Vr, Vt, Vp)
    ccall((:SHqst_to_spat_cplx, libshtns), Cvoid, (shtns_cfg, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}), arg1, Qlm, Slm, Tlm, Vr, Vt, Vp)
end

function spat_to_SH_l(arg1, Vr, Qlm, ltr)
    ccall((:spat_to_SH_l, libshtns), Cvoid, (shtns_cfg, Ptr{Cdouble}, Ptr{cplx}, Cint), arg1, Vr, Qlm, ltr)
end

function SH_to_spat_l(arg1, Qlm, Vr, ltr)
    ccall((:SH_to_spat_l, libshtns), Cvoid, (shtns_cfg, Ptr{cplx}, Ptr{Cdouble}, Cint), arg1, Qlm, Vr, ltr)
end

function SHsphtor_to_spat_l(arg1, Slm, Tlm, Vt, Vp, ltr)
    ccall((:SHsphtor_to_spat_l, libshtns), Cvoid, (shtns_cfg, Ptr{cplx}, Ptr{cplx}, Ptr{Cdouble}, Ptr{Cdouble}, Cint), arg1, Slm, Tlm, Vt, Vp, ltr)
end

function SHtor_to_spat_l(arg1, Tlm, Vt, Vp, ltr)
    ccall((:SHtor_to_spat_l, libshtns), Cvoid, (shtns_cfg, Ptr{cplx}, Ptr{Cdouble}, Ptr{Cdouble}, Cint), arg1, Tlm, Vt, Vp, ltr)
end

function spat_to_SHsphtor_l(arg1, Vt, Vp, Slm, Tlm, ltr)
    ccall((:spat_to_SHsphtor_l, libshtns), Cvoid, (shtns_cfg, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{cplx}, Ptr{cplx}, Cint), arg1, Vt, Vp, Slm, Tlm, ltr)
end

function spat_to_SHqst_l(arg1, Vr, Vt, Vp, Qlm, Slm, Tlm, ltr)
    ccall((:spat_to_SHqst_l, libshtns), Cvoid, (shtns_cfg, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}, Cint), arg1, Vr, Vt, Vp, Qlm, Slm, Tlm, ltr)
end

function SHqst_to_spat_l(arg1, Qlm, Slm, Tlm, Vr, Vt, Vp, ltr)
    ccall((:SHqst_to_spat_l, libshtns), Cvoid, (shtns_cfg, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}, Cint), arg1, Qlm, Slm, Tlm, Vr, Vt, Vp, ltr)
end

function spat_to_SH_ml(arg1, im, Vr, Ql, ltr)
    ccall((:spat_to_SH_ml, libshtns), Cvoid, (shtns_cfg, Cint, Ptr{cplx}, Ptr{cplx}, Cint), arg1, im, Vr, Ql, ltr)
end

function SH_to_spat_ml(arg1, im, Ql, Vr, ltr)
    ccall((:SH_to_spat_ml, libshtns), Cvoid, (shtns_cfg, Cint, Ptr{cplx}, Ptr{cplx}, Cint), arg1, im, Ql, Vr, ltr)
end

function spat_to_SHsphtor_ml(arg1, im, Vt, Vp, Sl, Tl, ltr)
    ccall((:spat_to_SHsphtor_ml, libshtns), Cvoid, (shtns_cfg, Cint, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}, Cint), arg1, im, Vt, Vp, Sl, Tl, ltr)
end

function SHsphtor_to_spat_ml(arg1, im, Sl, Tl, Vt, Vp, ltr)
    ccall((:SHsphtor_to_spat_ml, libshtns), Cvoid, (shtns_cfg, Cint, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}, Cint), arg1, im, Sl, Tl, Vt, Vp, ltr)
end

function SHtor_to_spat_ml(arg1, im, Tl, Vt, Vp, ltr)
    ccall((:SHtor_to_spat_ml, libshtns), Cvoid, (shtns_cfg, Cint, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}, Cint), arg1, im, Tl, Vt, Vp, ltr)
end

function spat_to_SHqst_ml(arg1, im, Vr, Vt, Vp, Ql, Sl, Tl, ltr)
    ccall((:spat_to_SHqst_ml, libshtns), Cvoid, (shtns_cfg, Cint, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}, Cint), arg1, im, Vr, Vt, Vp, Ql, Sl, Tl, ltr)
end

function SHqst_to_spat_ml(arg1, im, Ql, Sl, Tl, Vr, Vt, Vp, ltr)
    ccall((:SHqst_to_spat_ml, libshtns), Cvoid, (shtns_cfg, Cint, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}, Cint), arg1, im, Ql, Sl, Tl, Vr, Vt, Vp, ltr)
end

function SH_to_point(arg1, Qlm, cost, phi)
    ccall((:SH_to_point, libshtns), Cdouble, (shtns_cfg, Ptr{cplx}, Cdouble, Cdouble), arg1, Qlm, cost, phi)
end

function SH_to_point_cplx(arg1, alm, cost, phi)
    ccall((:SH_to_point_cplx, libshtns), cplx, (shtns_cfg, Ptr{cplx}, Cdouble, Cdouble), arg1, alm, cost, phi)
end

function SH_to_grad_point(arg1, DrSlm, Slm, cost, phi, vr, vt, vp)
    ccall((:SH_to_grad_point, libshtns), Cvoid, (shtns_cfg, Ptr{cplx}, Ptr{cplx}, Cdouble, Cdouble, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}), arg1, DrSlm, Slm, cost, phi, vr, vt, vp)
end

function SHqst_to_point(arg1, Qlm, Slm, Tlm, cost, phi, vr, vt, vp)
    ccall((:SHqst_to_point, libshtns), Cvoid, (shtns_cfg, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}, Cdouble, Cdouble, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}), arg1, Qlm, Slm, Tlm, cost, phi, vr, vt, vp)
end
...
function SHqst_to_lat(arg1, Qlm, Slm, Tlm, cost, vr, vt, vp, nphi, ltr, mtr)
    ccall((:SHqst_to_lat, libshtns), Cvoid, (shtns_cfg, Ptr{cplx}, Ptr{cplx}, Ptr{cplx}, Cdouble, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}, Cint, Cint, Cint), arg1, Qlm, Slm, Tlm, cost, vr, vt, vp, nphi, ltr, mtr)
end
